...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { author: @publication.author, body: @publication.body, drop: @publication.drop } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { author: @publication.author, body: @publication.body, drop: @publication.drop } }
